...
\begin{frame}{Score-Based Generative Modeling Through SDE (no details)}
  \begin{minipage}[h]{0.45\textwidth}
    \begin{center}
      \footnotesize 
      \textbf{Discrete Time} Markov Chain with \textbf{Continuous} State Space
    \end{center}
    \begin{figure}[h]
      \centering
  ...
  \begin{minipage}[h]{0.45\textwidth}
    \begin{center}
      \footnotesize 
      \textbf{\color{rred} Continuous Time} Markov Chain with
      \textbf{Continuous} State Space\\
    \end{center}
    \begin{figure}[h]
      \centering
...
\end{frame}
%\begin{frame}{Continous Diffusion Process}
%  \begin{figure}[h!]
%    \centering
%    \includegraphics[width=0.6\textwidth]{./pic/sde_overview.png}
%  \end{figure}
%\end{frame}
\section{DALL-E}
\begin{frame}{Samples}
